...
public final class Constants
{
  ...
  public static class ClimberConstants {
    ...
    public static final double kArmRotationDistance = 130.0/360.0;
    ...
    public static final double kDeployPosition = 127.0/360.0 * kArmGearBoxRatio;//kArmRotationDistance * kArmGearBoxRatio;
    ...
    public static final double kLiftPosition = 30.0/360.0 * kArmGearBoxRatio;
