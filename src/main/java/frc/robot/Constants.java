...
public final class Constants
{
  ...
  public static class ClimberConstants {
    ...
    public static final double kArmRotationDistance = 120.0/360.0;
    ...
    public static final double kDeployPosition = 120.0/360.0 * kArmGearBoxRatio;//kArmRotationDistance * kArmGearBoxRatio;
