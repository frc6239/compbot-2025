...
this.m_climbMotor = new SparkMax(ClimberSubsystem.CANidClimbMotor, MotorType.kBrushless);
        ...
        this.m_climbMotor.configure(this.motorConfig, (SparkBase.ResetMode)null, (SparkBase.PersistMode)null);
